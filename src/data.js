...
const urlConcatenar = forFetch(comedyMovies);
...
function forFetch(comedyMovies){
  const urlConcatenar = [];
  for(i = 0; i < comedyMovies.length; i++){
    urlConcatenar[i] = 'http://www.omdbapi.com/?i=' + comedyMovies[i] + '&apikey=f30c02c5';
  }
...
function showMovies (movies){
  const div = document.getElementById('movieCardsSad');
  div.innerHTML = " ";
      ...
      `<div class="card mb-3 col-md-4 col-sm-12" style="max-width: 540px;">
        <div class="row no-gutters">
          <div class="col-md-4 col-sm-12">
            <img src="${movies.Poster}" class="card-img" alt="...">
          </div>
...
function showMovies2 (movies2){
  const div = document.getElementById('movieCardsSmile');
  div.innerHTML = " ";
  ...
  movies2.map((movies2) => {
   ...
   <div class="row no-gutters">
     <div class="col-md-4 col-sm-12">
      <img src="${movies2.Poster}" class="card-img" alt="...">
     </div>
     <div class="col-md-8 d-none d-md-block">
       <div class="card-body">
...
function showMovies3 (movies3){
  const div = document.getElementById('movieCardsBored');
  div.innerHTML = " ";
  ...
  movies3.map((movies3) => {
   ...
   <div class="row no-gutters">
     <div class="col-md-4 col-sm-12">
      <img src="${movies3.Poster}" class="card-img" alt="...">
     </div>
     <div class="col-md-8 d-none d-md-block">
       <div class="card-body">
